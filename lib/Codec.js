...
Codec["toArrayBuffer"] = toArrayBuffer;
                                ...
                                //                     callback:Function, failed:Function = null):void
...
//}@dev
    var rv = [], i = 0, iz = source.length, bulkSize = 24000;
...
function toArrayBuffer(source,   // @arg BlobURLString|URLString|Blob|File|TypedArray|ArrayBuffer
                       ...
                       failed) { // @arg Function = null - failed(err:Error, source:Any):void
            ...
            if (typeof source === "string") { // BlobURLString or URLString
                ...
                xhr["onload"] = function() {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        failed( new Error(xhr["statusText"] || "", source) );
                    }
                };
